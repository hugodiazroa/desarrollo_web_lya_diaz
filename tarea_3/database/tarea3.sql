...
-- -----------------------------------------------------
-- Table `tarea3`.`miembro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tarea3`.`miembro` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tarea3`.`comentario`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `tarea3`.`comentario` (
  `id` INT NOT NULL AUTO_INCREMENT,
